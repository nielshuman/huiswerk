function [d,h,m,s]=progressbar(fractiondone, position, title)
d=0;h=0;m=0;s=0;
% Description:
...
if (fractiondone == 0)
    ...
    [timeleftstr,d,h,m,s] = sec2timestr(timeleft);
    titlebarstr = [title ' ... ' sprintf('%2d%%    %s remaining',percentdone,timeleftstr)];
end
...
% ------------------------------------------------------------------------------
function [timestr,d,h,m,s] = sec2timestr(sec)
