...
for P=1:size(P2,1)
    preprocessed_filename=[DRIVE '\data\Patient_' num2str(P2(P,1)) '_preprocessed_data_site' num2str(P2(P,3)) '_CH' num2str(P2(P,2))   '.mat'];
...
saveas(gcf,[DRIVE '/results/Results_part2.png'])
